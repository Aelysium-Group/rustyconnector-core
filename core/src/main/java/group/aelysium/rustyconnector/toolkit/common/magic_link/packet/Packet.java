...
public class Packet implements JSONParseable {
    ...
    private List<Consumer<group.aelysium.rustyconnector.toolkit.common.magic_link.packet.Packet>> replyListeners = null; // Intentionally left null, if no responses are saved here, we don't want to bother instantiating a list here.
     ...
     */
    public List<Consumer<group.aelysium.rustyconnector.toolkit.common.magic_link.packet.Packet>> replyListeners() {
     ...
     */
    public void handleReply(Consumer<group.aelysium.rustyconnector.toolkit.common.magic_link.packet.Packet> response) {
    ...
    public static class Builder {
        ...
        public static class PrepareForSending {
            ...
            /**
             * Prepares the packet as a reply to the specified {@link group.aelysium.rustyconnector.toolkit.common.magic_link.packet.Packet}.
             * @throws RuntimeException If this packet was already sent or used in a reply, and then you try to send it again.
             */
            public ReadyForSending addressedTo(group.aelysium.rustyconnector.toolkit.common.magic_link.packet.Packet targetPacket) {
