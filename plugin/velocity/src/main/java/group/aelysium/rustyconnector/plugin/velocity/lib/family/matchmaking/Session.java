package group.aelysium.rustyconnector.plugin.velocity.lib.family.matchmaking;
...
public class Session implements ISession {
    ...
    public IPlayerConnectable.Request join(IMatchPlayer matchPlayer) {
        CompletableFuture<ConnectionResult> result = new CompletableFuture<>();
        IPlayerConnectable.Request request = new IPlayerConnectable.Request(matchPlayer.player(), result);
