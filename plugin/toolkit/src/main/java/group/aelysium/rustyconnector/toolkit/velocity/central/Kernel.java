 ...
 */
public abstract class Kernel implements Particle {
    /**
    ...
    abstract class Tinder extends group.aelysium.rustyconnector.toolkit.common.absolute_redundancy.Particle.Tinder<Particle> {
    }
}
