package group.aelysium.rustyconnector.toolkit.proxy.magic_link.packet_handlers;

import group.aelysium.rustyconnector.common.magic_link.Packet;
import group.aelysium.rustyconnector.common.buitin_packets.MagicLink;
...
public class HandshakePingListener extends PacketListener<MagicLink.Handshake.Ping> {
    ...
    public void execute(MagicLink.Handshake.Ping packet) throws Exception {
        try {
            ...
            MagicLinkCore.Proxy.MagicLinkMCLoaderSettings config = magicLink.magicConfig(packet.magicConfigName()).orElseThrow(
