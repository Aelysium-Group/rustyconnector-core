...
public abstract class PacketListener<Packet extends group.aelysium.rustyconnector.toolkit.common.magic_link.packet.Packet> {
    ...
    public final void wrapAndExecute(group.aelysium.rustyconnector.toolkit.common.magic_link.packet.Packet packet) throws Exception {
     ...
     * @param <Packet>
     */
    public static abstract class Wrapper<Packet extends group.aelysium.rustyconnector.toolkit.common.magic_link.packet.Packet> {
        public abstract Packet wrap(group.aelysium.rustyconnector.toolkit.common.magic_link.packet.Packet packet);
    }
}
