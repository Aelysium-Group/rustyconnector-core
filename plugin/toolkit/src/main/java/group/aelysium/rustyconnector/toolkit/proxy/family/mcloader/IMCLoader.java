...
public interface IMCLoader extends ISortable, IPlayerConnectable {
    ...
    record Unregistered(
         ...
         * @param family The family to register into.
         * @return A registered MCLoader.
         */
        public @NotNull IMCLoader register(IFamily family) {
            IMCLoader mcloader =;
            RC.P.Adapter().registerMCLoader();
            family.connector().register(this);
        }
    }
}
